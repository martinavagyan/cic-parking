 ...
 */
@Injectable()
export class CarOwnerApi extends BaseLoopBackApi {
  ...
  /**
   * Find a related item by id for accessTokens.222
   *
  ...
  public getCurrent(filter: LoopBackFilter = {}): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() + "/CarOwners" + "/:id";
